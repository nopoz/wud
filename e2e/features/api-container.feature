Feature: WUD Container API Exposure
  ...
  Scenario Outline: WUD must allow to get all containers
    ...
    Examples:
      ...
      | 3     | ghcr.private   | ghcr_radarr              | https://ghcr.io/v2                                      | linuxserver/radarr                  | 5.14.0.9383-ls245  | 5.26.2.10099-ls276  | true            |
      | 4     | gitlab.private | gitlab_test              | https://registry.gitlab.com/v2                          | manfred-martin/docker-registry-test | 1.0.0              | 2.0.0              | true            |
      | 5     | hub.public     | hub_homeassistant_202161 | https://registry-1.docker.io/v2                         | homeassistant/home-assistant        | 2021.6.1           |2025.7.0           | true            |
      ...
      | 13    | hub.public     | hub_traefik_245          | https://registry-1.docker.io/v2                         | library/traefik                     | 2.4.5              | 3.4.3              | true            |
      | 14    | hub.public     | hub_traefik_latest       | https://registry-1.docker.io/v2                         | library/traefik                     | latest             | latest             | false           |
      | 15    | hub.public     | hub_vaultwarden_1222     | https://registry-1.docker.io/v2                         | vaultwarden/server                  | 1.34.1-alpine      | 1.34.1-alpine      | false           |
      ...
      | 18    | lscr.private   | lscr_radarr              | https://lscr.io/v2                                      | linuxserver/radarr                  | 5.14.0.9383-ls245  | 5.26.2.10099-ls276  | true            |
  ...
  Scenario: WUD must allow to get a container with digest
    ...
    And response body path $.result.digest should be sha256:13920fe73b382aa9017f7cf38b1377bc46ffb605fe980eb00f61aad26311ebf7
    And response body path $.updateAvailable should be true
  ...
  Scenario: WUD must allow to get a container with its link
    ...
    And response body path $.result.link should be https://github.com/home-assistant/core/releases/tag/2025.7.0
