Feature: WUD Container API Exposure
  ...
  Scenario Outline: WUD must allow to get all containers
    ...
    Examples:
      ...
      | 3     | ghcr.private   | ghcr_radarr              | https://ghcr.io/v2                                      | linuxserver/radarr                  | 5.14.0.9383-ls245  | 5.17.2.9580-ls253  | true            |
      ...
      | 18    | lscr.private   | lscr_radarr              | https://lscr.io/v2                                      | linuxserver/radarr                  | 5.14.0.9383-ls245  | 5.17.2.9580-ls253  | true            |
  ...
  Scenario: WUD must allow to get a container with digest
    ...
    And response body path $.result.digest should be sha256:c375ae41bb29c0615ab18452822fedf1981f8ba7a7b00508b3d901b7ab682947
    And response body path $.updateAvailable should be true
