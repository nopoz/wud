...
describe('Rocketchat Trigger', () => {
    ...
    test('should validate configuration with required fields', () => {
        const config = {
    ...
    test('should throw error when auth token is missing', () => {
        const config = {
            url: 'https://open.rocket.chat',
            user: { id: 'test' },
            auth: {},
    ...
    test('should mask configuration sensitive data', () => {
